...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`easyapplication`}</title>

        <meta
          name="description"
          content="Welcome to EasyApplication, your comprehensive WhatsApp application, integrating effortlessly with all ATS systems for seamless communication."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1636751364472-12bfad09b451?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx3aGF0c2FwcHxlbnwwfHx8fDE2OTYxNDc4NDV8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to EasyApplication, your comprehensive WhatsApp application, integrating effortlessly with all ATS systems for seamless communication.`}
            </Text>
            <Box
